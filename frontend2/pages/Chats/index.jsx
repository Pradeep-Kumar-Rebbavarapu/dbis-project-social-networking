...
export default function Chats() {
  ...
  const UsersChattedWith = useQuery({ queryKey: ["usersChattedWith"], queryFn: ()=>{
          ...
          <div className="row">
            <div className="col-12">
                    ...
                    <div className="modal-content ">
                      <div className="chat-header ">
                        <div className="msg-search">
                          ...
                          <a className="add" href="#"><img className="!mx-2" src="https://mehedihtml.com/chatbox/assets/img/add.svg" alt="add" /></a>
                        </div>
                      ...
                      <div className="modal-body !overflow-scroll !h-full !p-0 !m-0">
                        ...
                        <div className="chat-lists !overflow-scroll !h-full !p-0 !m-0">
                          <div className="tab-content !overflow-scroll !h-full !p- !m-0" id="myTabContent">
                            <div className="tab-pane fade show active !overflow-scroll !h-full !p-0 !m-0" id="Open" role="tabpanel" aria-labelledby="Open-tab">
                              {/* <!-- chat-list --> */}
                              <div className="chat-list !overflow-scroll !h-screen !p-0 !m-0">
                                ...
                                {UsersChattedWith?.data?.map((ele, index) => {
                                  return (
                                    <div  id={`${ele.name}-${index}`} className="flex items-center !py-3 cursor-pointer" key={index} onClick={() => {

                                      setReceiver(ele.user.id)
                                      setReceiverName(ele.user.username)
                                      post1.mutate({"receiver":ele.user.id,"access":auth.access})

                                    }}>

                                      <div className="flex-shrink-0 relative">
                                        <img className="!mx-2" src="https://mehedihtml.com/chatbox/assets/img/user.png" alt="user img" />
                  ...
                  <div className="modal-dialog-scrollable ">
                    <div className="modal-content h-full">
                        ...
                        <div className="row">
                          <div className="col-8">
                            <div className="flex items-center !py-3">
                              <span className="chat-icon"><img className="!mx-2" src="https://mehedihtml.com/chatbox/assets/img/arroleftt.svg" alt="image title" /></span>
                      ...
                      <div className="modal-body !overflow-scroll !h-full !pb-10">
                        <div id="msg-body" className="msg-body !overflow-scroll !h-full">
                          <ul className=' !overflow-scroll !h-full'>
                            {EachUsersMessages?.map((ele, index) => {
                              return (
                                <div className='' key={index}>
                                  <li className={`${auth.user.pk === ele.sender ? "sender" : "repaly"}`}>
                                    <p> {ele.message} </p>
                                    <span className="time">{ele.created_at}</span>
                                  </li>
                                </div>
                              )
                            })}
              ...
              <div className="send-box flex">
                  ...
                  <input type="text" className="form-control" aria-label="message…" placeholder="Write message…" onChange={(e) => {
...
const fetchUsersChats = async (data) => {
  return axios.post(`http://127.0.0.1:8000/api/v1/__get__chats__related__to__user__and__receiver__/`, data, {
    headers: {
...
export const fetchUsersChattedWith = async (access) => {
  return axios.get('http://127.0.0.1:8000/api/v1/__get__users__who__logged__in__user__has__chatted__/', {
    headers: {
...
export async function getServerSideProps(context) {
  ...
  await queryClient.prefetchQuery({ queryKey: ["usersChattedWith"], queryFn: ()=>{
    return fetchUsersChattedWith(auth.access)
